            ...
            config.pc.ontrack = function (event) {
                ...
                event.track.onended = function (ev) {
                    ...
                    try {
                        ...
                        Janus.error(
                            'Error calling onremotetrack on removal',
                            e
                        );
                    }
                    ...
                    if (track.replace) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                Janus.log(
                                    'Enabling Simulcasting for Firefox (RID)'
                                );
                                transceiver = config.pc.addTransceiver(nt, {
                                    direction: 'sendrecv',
                                    streams: [config.myStream],
...
export default s() as typeof JanusJS.Janus;
