...
> = {
    ...
    'mental-arithmetics': [
        getLesson(MAO_1),
        getLesson(MAO_2),
        getLesson(MAO_ANZAN_1),
        getLesson(MAO_ANZAN_2),
        getLesson(MAO_ANZAN_3),
        getLesson(MAO_ANZAN_4),
        getLesson(MAO_ANZAN_5),
        getLesson(MAO_ANZAN_6),
        getLesson(MAO_ANZAN_7),
        getLesson(MAO_ANZAN_8),
        getLesson(MAO_ANZAN_9),
        getLesson(MAO_ANZAN_10),
        getLesson(MAO_ANZAN_11),
