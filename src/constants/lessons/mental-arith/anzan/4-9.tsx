...
const LESSONS_MENTAL_ARITH_ANZAN: ILesson[] = [
    ...
    },
    {
        ...
        secondTitle:
            'Закрепление темы "Анзан". Только сложение. Только вычитание. Однозначные',
        status: true,
        index: 2,
        name: 'game',
        games: ['countExamples'],
    ...
    },
    {
        ...
        items: [
            {
                title: 'Закрепили счет по теме "Анзан", подтема "Сложение" и подтема "Вычитание" на физическом абакусе (однозначные с промежуточным двузначным ответом)',
            },
            {
