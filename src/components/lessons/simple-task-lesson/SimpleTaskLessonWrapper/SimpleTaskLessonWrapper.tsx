...
export const SimpleTaskLessonWrapper: FC<
    PropsWithChildren<{ disabled?: boolean; imgSrc: string }>
> = ({ children, disabled, imgSrc }) => {
    const [lesson] = useCurrentLesson();
    return (
        <div className={styles.content__box}>
            <div className={styles.content__wrap}>
                <p className={styles.content__text}>{lesson.secondTitle}</p>
                <div>
                    <div className={styles.content__container}>
                        ...
                        <div
                            className={styles.content__component_wrapper}
